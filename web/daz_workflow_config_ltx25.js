...
// ── LTX2.5 — edit panel: Models box ──────────────────────────────────────────
// One CLIP slot only: LTX2.5's text encoder file already carries the projection
// weights that LTX2.3 kept in a separate second file.
...
// ── LTX2.5 — edit panel: Dimensions box ──────────────────────────────────────
...
// ── LTX2.5 — edit panel: payload builder ─────────────────────────────────────
...
app.registerExtension(buildWorkflowConfigExtension({
  ...
  keys: {
    ...
    editMode:        '_dazLtx25EditMode',
    editOverlay:     '_dazLtx25EditOverlay',
    wrap:            '_dazLtx25Wrap',
    executedHandler: '_dazLtx25ExecutedHandler',
    domWidget:       'daz_ltx25_detail',
  },
